...
class OrderedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val trans1 = Transaction("1", 1, Date(), Date(), 10000.0, "B5314. Scream 2022 - Tiếng Thét 2022 2D25G (DTS-HD MA 7.1)")
        val trans2 = Transaction("1", 2, Date(), Date(), 20000.0, "B5306. Turning Red 2022 - Gấu Đỏ Biến Hình 2D25G (DTS-HD MA 7.1)")
        val trans3 = Transaction("1", 3, Date(), Date(), 30000.0, "B5299. Blacklight 2022 - Phi Vụ Đen 2D25G (DTS-HD MA 7.1)")
        ...
        RVOrdered.addItemDecoration(DividerItemDecoration(requireActivity(), layoutManager.orientation))
        return view
    }
