 ...
 * Use the [StatisticRevenueFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class StatisticRevenueFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_statistic_revenue, container, false)

        val url = "https://vfilm-83cf4-default-rtdb.asia-southeast1.firebasedatabase.app/"
        val ref = FirebaseDatabase.getInstance(url).getReference("film")

        val sellerFilm = ArrayList<Film>()
        val rcvSellerFilmList = view.findViewById<RecyclerView>(R.id.rcvRevenueStatisticList)
        val revenueAdapter = RevenueStatisticAdapter(sellerFilm)
        ...
        revenueAdapter.onItemClick = { film ->
            val intent = Intent(requireActivity(), RevenueStatisticDetailActivity::class.java)
    ...
    companion object {
         ...
         * @return A new instance of fragment StatisticRevenueFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            StatisticRevenueFragment().apply {
